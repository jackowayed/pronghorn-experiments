...
class FloodlightContainer:
    def launch_container(self, ofbind=None, restbind=None, num_retries=20):
        try:
            ...
            print e
            if num_retries > 0:
                self.launch_container(random.randint(10000,20000), random.randint(10000,20000), num_retries-1)
            else:
                raise e
